...
[![x-cmd/install — gop Code Quality Monitoring Repo Card](https://repo.x-cmd.io/gop.svg?lang=zh)](https://x-cmd.com/install/gop)
...
合计: **55,724** 行代码（覆盖前 5 种语言、共 **380** 个文件）。
...
- **上游仓库**: <https://github.com/goplus/gop>
- **官网**: <https://xgo.dev>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v1.7.5` (2026-07-22)
- **最近提交**: 2026-09-19
- **Release 含资产**: 15 个

## 流行度

- **Star**: 9,458 · **Fork**: 566 · **开放 issue**: 643 · **贡献者**: 46

## 累计统计

- **发布数**: 140 · **已合并 PR**: 1934 · **开放 PR**: 15 · **已关闭 issue**: 613 · **开放 issue**: 30 · **提交数**: 6214
...
| last180d | 2026-03-25 | 7 | 0 | 0 | 0 | 0 | 0 |
...
gop 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `gop` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gop.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T05:55:09Z._
